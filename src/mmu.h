...
page_table_entry* tabla_de_paginas_del_mapa_del_jugador_A_2;
page_table_entry* tabla_de_paginas_del_mapa_del_jugador_A_3;
page_table_entry* tabla_de_paginas_del_mapa_del_jugador_A_4;
page_table_entry* tabla_de_paginas_del_mapa_del_jugador_A_5;

page_table_entry* tabla_de_paginas_del_mapa_del_jugador_B_2;
page_table_entry* tabla_de_paginas_del_mapa_del_jugador_B_3;
page_table_entry* tabla_de_paginas_del_mapa_del_jugador_B_4;
page_table_entry* tabla_de_paginas_del_mapa_del_jugador_B_5;
...
void mmu_mapear_pagina(unsigned int direccion_virtual, unsigned int direccion_fisica, 
                       page_directory_entry* directorio_de_paginas, uint32_t att);//modificado: att es us,r/w (bits 1,0)
